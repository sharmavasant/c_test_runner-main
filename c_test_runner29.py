...
def extract_function(source_file, fn_name, src_dir):
    ...
    # Build minimal extracted .c with ONLY ctest_types.h + the function body.
    # No project headers are included — this avoids all SDK include chain
    # problems. ctest_types.h provides uint8_t/uint32_t etc.
